...
import 'package:lpm/components/register_dialog.dart';
...
class _LoginDialogState extends State<LoginDialog> {
  ...
  final String _welcome = 'Welcome Again!';
        ...
        await _auth
          ...
          if (value.user != null) {
            if (_remember) {
              ...
              if (!emails.contains(_emailController.text)) emails.insert(0, _emailController.text);
                  ...
                  Tooltip(
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        ...
                        showDialog(
                          context: context,
                          builder: (context) => RegisterDialog(widget.onLoggedIn),
                        );
